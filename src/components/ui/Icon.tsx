...
export function CloseIcon({ size }: { size?: IconSize }) {
  return (
    <Icon size={size}>
...
export function ChevronRightIcon({ size }: { size?: IconSize }) {
  return (
    <Icon size={size}>
...
export function SunIcon({ size }: { size?: IconSize }) {
  return (
    <Icon size={size}>
...
export function MoonIcon({ size }: { size?: IconSize }) {
  return (
    <Icon size={size}>
...
export function UndoIcon({ size }: { size?: IconSize }) {
  return (
    <Icon size={size}>
...
export function RedoIcon({ size }: { size?: IconSize }) {
  return (
    <Icon size={size}>
...
export function ZoomInIcon({ size }: { size?: IconSize }) {
  return (
    <Icon size={size}>
      <path fillRule="evenodd" d="M10 3a1 1 0 011 1v5h5a1 1 0 110 2h-5v5a1 1 0 11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 011-1z" clipRule="evenodd" />
    </Icon>
...
export function ZoomOutIcon({ size }: { size?: IconSize }) {
  return (
    <Icon size={size}>
...
export function KeyboardIcon({ size }: { size?: IconSize }) {
  return (
    <Icon size={size}>
...
export function MenuIcon({ size }: { size?: IconSize }) {
  return (
    <Icon size={size}>
...
export function InfoIcon({ size }: { size?: IconSize }) {
  return (
    <Icon size={size}>
